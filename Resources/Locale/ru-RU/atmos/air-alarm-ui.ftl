...
air-alarm-ui-window-alarm-state = [color={ $color }]{-air-alarm-state-name(статус:$state)}[/color]
air-alarm-ui-window-alarm-state-indicator = Статус: [color={ $color }]{-air-alarm-state-name(статус:$state)}[/color]
